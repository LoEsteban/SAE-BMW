...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('equipements_moto', function (Blueprint $table) {
            ...
            $table->foreignId('idcategorieequipementmoto')->constrained(table:'categories_equipement_moto', column:'idcategorieequipementmoto');
    ...
    {
        Schema::dropIfExists('equipements_moto');
    }
};
