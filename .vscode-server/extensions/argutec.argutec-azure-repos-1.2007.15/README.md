...
This extension allows you to connect to Azure DevOps Services and Team Foundation Server and provides support for [Team Foundation Version Control (TFVC)](https://github.com/argutec-sro/azure-repos-vscode/blob/master/TFVC_README.md#quick-start). 
...
![Azure Repos extension](https://github.com/argutec-sro/azure-repos-vscode/raw/master/assets/vscode.png)
...
## TFVC Support
Once you have a local TFVC workspace available, you must configure the TFVC support in Visual Studio Code. You can find that information (including demo videos) in our [TFVC documentation](https://github.com/argutec-sro/azure-repos-vscode/blob/master/TFVC_README.md).
...
![Team Error indicator](https://github.com/argutec-sro/azure-repos-vscode/raw/master/assets/team-error.png)
...
* ![Team Project indicator](https://github.com/argutec-sro/azure-repos-vscode/raw/master/assets/project-indicator.png) – This status bar item is populated with the name
of the team project to which the repository belongs. Clicking on the item will open your browser to the team website.

* ![Pull Requests indicator](https://github.com/argutec-sro/azure-repos-vscode/raw/master/assets/pullrequest-indicator.png) – ***Git only*** This status bar item is a count of active
...
* ![Build Status indicator](https://github.com/argutec-sro/azure-repos-vscode/raw/master/assets/buildstatus-indicator.png) – This status bar item shows the status of
...
* ![Pinned Work Item Query Status indicator](https://github.com/argutec-sro/azure-repos-vscode/raw/master/assets/pinnedquery-indicator.png) – This status bar item shows
...
* ![Feedback indicator](https://github.com/argutec-sro/azure-repos-vscode/raw/master/assets/feedback-indicator.png) – Clicking this status bar item allows you to quickly send
...
**Note:** If you're using a Team Foundation Version Control repository, you should *not* use these settings. Have a look at the [TFVC Quick Start](https://github.com/argutec-sro/azure-repos-vscode/blob/master/TFVC_README.md#quick-start).
...
See the [developer documentation](https://github.com/argutec-sro/azure-repos-vscode/blob/master/CONTRIBUTING.md) for details on how to contribute to this extension.

## Code of Conduct
This project has adopted the [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/). For more information see the [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) or contact [opencode@microsoft.com](https://github.com/argutec-sro/azure-repos-vscode/blob/master/mailto:opencode@microsoft.com) with any additional questions or comments.
...
## License
This extension is [licensed under the MIT License](https://github.com/argutec-sro/azure-repos-vscode/blob/master/LICENSE.txt). Please see the [third-party notices](https://github.com/argutec-sro/azure-repos-vscode/blob/master/ThirdPartyNotices.txt)
